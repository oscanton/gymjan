/* =========================================
   data/menus/week_menu_default.js - DATOS
   ========================================= */

// --- 3. PLAN: MENUS SEMANAL ---
window.MENU_DATA = [
    {
        day: "Lunes",
        breakfast: {
            items: [
                ...
                { foodId: "plain_yogurt", amount: 195 },
                { foodId: "oats", amount: 35 },
        ...
        lunch: {
            items: [
                ...
                { foodId: "rice", amount: 140 },
                { foodId: "zucchini", amount: 195 },
                { foodId: "salad", amount: 165 },
        ...
        dinner: {
            items: [
                { foodId: "hake", amount: 175 },
                { foodId: "spinach", amount: 230 },
                { foodId: "zucchini", amount: 135 },
                { foodId: "olive_oil", amount: 5 },
    ...
    },
    {
        ...
        breakfast: {
            items: [
                { foodId: "coffee", amount: 1 },
                { foodId: "wholegrain_bread", amount: 40 },
                { foodId: "tomato", amount: 115 },
                { foodId: "olive_oil", amount: 10 },
                { foodId: "turkey", amount: 25 },
        ...
        lunch: {
            items: [
                { foodId: "turkey", amount: 230 },
                { foodId: "lentils", amount: 190 },
                { foodId: "carrot", amount: 135 },
                { foodId: "bell_pepper", amount: 185 },
                { foodId: "olive_oil", amount: 10 },
        ...
        dinner: {
            items: [
                { foodId: "loin_pork", amount: 155 },
                { foodId: "salad", amount: 145 },
                { foodId: "tomato", amount: 75 },
                { foodId: "olive_oil", amount: 5 },
    ...
    },
    {
        ...
        lunch: {
            items: [
                { foodId: "hake", amount: 230 },
                { foodId: "rice_wholegrain", amount: 135 },
                { foodId: "broccoli", amount: 140 },
                { foodId: "tomato", amount: 105 },
                { foodId: "olive_oil", amount: 5 },
                { foodId: "plain_yogurt", amount: 170 }
            ],
        ...
        dinner: {
            items: [
                ...
                { foodId: "broccoli", amount: 165 },
                { foodId: "cauliflower", amount: 125 },
                { foodId: "olive_oil", amount: 5 },
    ...
    },
    {
        ...
        lunch: {
            items: [
                ...
                { foodId: "chickpeas", amount: 175 },
                { foodId: "spinach", amount: 225 },
                { foodId: "tomato", amount: 65 },
                { foodId: "olive_oil", amount: 5 },
        ...
        dinner: {
            items: [
                { foodId: "squid", amount: 160 },
                { foodId: "salad", amount: 185 },
                { foodId: "vegetables", amount: 140 },
                { foodId: "olive_oil", amount: 10 },
    ...
    },
    {
        ...
        breakfast: {
            items: [
                { foodId: "coffee", amount: 1 },
                { foodId: "wholegrain_bread", amount: 65 },
                { foodId: "avocado", amount: 65 },
                { foodId: "egg", amount: 1 },
        ...
        lunch: {
            items: [
                { foodId: "beef", amount: 185 },
                { foodId: "quinoa", amount: 160 },
                { foodId: "zucchini", amount: 220 },
                { foodId: "salad", amount: 215 },
                { foodId: "olive_oil", amount: 5 },
        ...
        dinner: {
            items: [
                { foodId: "turkey", amount: 140 },
                { foodId: "spinach", amount: 170 },
                { foodId: "tomato", amount: 85 },
                { foodId: "olive_oil", amount: 10 },
    ...
    },
    {
        ...
        lunch: {
            items: [
                { foodId: "tuna", amount: 220 },
                { foodId: "pasta_wholegrain", amount: 160 },
                { foodId: "bell_pepper", amount: 125 },
                { foodId: "zucchini", amount: 180 },
                { foodId: "olive_oil", amount: 10 },
    ...
    },
    {
        ...
        breakfast: {
            items: [
                { foodId: "coffee", amount: 1 },
                { foodId: "wholegrain_sandwich_bread", amount: 65 },
                { foodId: "cheese_fresh", amount: 165 },
                { foodId: "tomato", amount: 105 },
        ...
        lunch: {
            items: [
                { foodId: "salmon", amount: 225 },
                { foodId: "potato", amount: 190 },
                { foodId: "green_beans", amount: 220 },
                { foodId: "salad", amount: 180 },
                { foodId: "olive_oil", amount: 5 },
        ...
        dinner: {
            items: [
                { foodId: "beef", amount: 140 },
                { foodId: "zucchini", amount: 130 },
                { foodId: "mushrooms", amount: 145 },
                { foodId: "olive_oil", amount: 5 },
                { foodId: "plain_yogurt", amount: 105 },
